...
/// Punto único de entrada a las funciones Premium. Si el usuario ya tiene
/// acceso devuelve `true` sin mostrar nada; si no, abre [dialogBuilder].
///
/// Mientras no haya pasarela de pago, el CTA "Ver planes" del diálogo (que
/// cierra con `true`) activa el acceso de prueba de la sesión y deja
/// continuar con la acción que el usuario estaba haciendo.
